...
const SelectedAffirmation = () => {
    ...
    useEffect(() => {
        for (let i=0; i <AFFIRMATION_GALLERY.length; i++) {
            ...
            const selectedAffirmation = affirmationData.find((a)=>(a.id === Number(itemId)))
            if (selectedAffirmation) {
                setAffirmation(selectedAffirmation)
                const affirmationArray = selectedAffirmation.text.split('.')
...
export default SelectedAffirmation